...
if($status_akun) {
  $btn_enable_akun = "<button id='btn_verif__status_akun__0' class='btn_verif btn btn-danger' >Disable Akun</button>";
...
<script type="text/javascript">
  $(document).ready(function(){
    $(".btn_verif").click(function(){
      ...
      var link_ajax = "ajax_adm/ajax_set_akun.php?email="+email+"&field="+field+"&nilai="+nilai+"";
