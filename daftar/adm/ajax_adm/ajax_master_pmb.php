...
$sql_id_gelombang = " 1 ";
if($id_gelombang_filter!="all") $sql_id_gelombang = " c.id_gelombang='$id_gelombang_filter' ";

$sql_id_prodi = " 1 ";
if($id_prodi_filter!="all") $sql_id_prodi = " c.id_prodi1='$id_prodi_filter' ";

$sql_id_jalur = " 1 ";
if($id_jalur_filter!="all") $sql_id_jalur = " c.id_jalur='$id_jalur_filter' ";

$sql_nama_calon = " 1 ";
if($nama_calon_filter!="") $sql_nama_calon = " a.nama_calon like '%$nama_calon_filter%' ";
...
if($admin_level==1) $sql_status_wa_or_mail = " (status_no_wa = 1 OR status_email = 1) ";
if($admin_level==1) $sql_tanggal_submit = " c.tanggal_submit_formulir is not null ";
