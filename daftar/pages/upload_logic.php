...
if (mysqli_num_rows($q)) {
    ...
    while ($d=mysqli_fetch_assoc($q)) {
        ...
        if (mysqli_num_rows($q2)) {
            ...
            $id_verifikasi_cap = "<div class='mt-2 text-muted'><small>trx-id: $id_verifikasi</small></div>";
        }
        ...
        $status_upload_show = $softcopy_exist[$id_persyaratan] ? "<small><i class='ijo'>Sudah Upload $img_check</i></small>" : '';
