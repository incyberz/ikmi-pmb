...
if (mysqli_num_rows($q)==1) {
  ...
  ";
    ...
    if ($tanggal_lulus_tes != null) {
        ...
        if (1) {
            $link_hasil_reg_show = "<a href='$link_hasil_reg' target='_blank' class='btn btn-primary btn-sm'>Download Hasil Tes Jalur Reguler</a>";
        }

        $link_hasil_kip_show = "<div style='color:red'>Petugas belum memosting Link Hasil Jalur KIP </div>";
        if (1) {
            $link_hasil_kip_show = "<a href='$link_hasil_kip' target='_blank' class='btn btn-primary btn-sm'>Download Hasil Tes Jalur KIP</a>";
        }
