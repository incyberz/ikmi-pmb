...
function artikan_field($nama_field, $nilai)
{
    switch ($nama_field) {
        ...
        case 'pekerjaan_ibu':
            if ($nilai==1) {
                return 'PNS Dosen/Guru';
            }
            if ($nilai==2) {
                return 'PNS Non Kependidikan';
            }
            if ($nilai==3) {
                return 'Dosen/Guru Swasta';
            }
            if ($nilai==4) {
                return 'TNI/Polri';
            }
            ...
            if ($nilai==8) {
                return 'Petani/Peternak';
            }
            if ($nilai==9) {
                return 'Nelayan';
            }
            if ($nilai==10) {
                return 'Wirausaha Lainnya';
            }
            if ($nilai==11) {
        ...
        case 'lulusan':
            ...
            if ($nilai==11) {
                return 'Paket C (biasa)';
            }
            if ($nilai==12) {
                return 'Paket C Homeschooling';
            }
            if ($nilai==13) {
                return 'SMA Luar Negeri';
            }
            break;
        case 'status_daftar':
            if ($nilai==0) {
                return 'Registrasi via Gmail';
            }
            if ($nilai==1) {
                return 'Sudah melengkapi data saja';
            }
            if ($nilai==2) {
                return 'Sudah bayar atau syarat KIP Lengkap';
            }
            if ($nilai==3) {
                return 'Sudah Lengkap - Belum Tes';
            }
            if ($nilai==4) {
                return 'Sudah Lengkap - Lulus Seleksi';
            }
            if ($nilai==5) {
                return 'Sudah Registrasi Ulang';
            }
            if ($nilai==6) {
                return "-";
            }
            if ($nilai==7) {
                return 'Test Only (Whitebox Testing)';
            }
            if ($nilai==8) {
                return 'Mengundurkan Diri';
            }
            if ($nilai==9) {
                return 'Tidak Lulus Seleksi PMB';
            }
            break;
